...
// Verifica si el usuario es administrador o está autenticado como usuario
...
// Obtén el ID de la reserva y el estado deseado
$id = isset($_GET["id"]) ? $_GET["id"] : null;
$status = isset($_GET["status"]) ? $_GET["status"] : null;

if (isset($_SESSION["user"])) {
    // Asegúrate de que el usuario solo puede cancelar sus propias reservas
    ...
    // Solo permite cambiar el estado a 'cancelled' para los usuarios
    $status = 'cancelled';
}
